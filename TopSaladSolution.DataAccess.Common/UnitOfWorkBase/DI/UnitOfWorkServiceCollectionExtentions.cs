...
using TopSaladSolution.DataAccess.Common.UnitOfWorkBase.Uow;

namespace TopSaladSolution.DataAccess.Common.UnitOfWorkBase.DI
{
    public static class UnitOfWorkServiceCollectionExtentions
    {
        ...
        {
            services.AddScoped<IGenericRepositoryFactory, UnitOfWork<TContext>>();
