...
using TopSaladSolution.Infrastructure.Repositories.SQLHelpers.DataReaderExtends;

namespace TopSaladSolution.Infrastructure.Repositories.SQLHelpers
{
    public class SqlHelper : ISQLHelpers
    {
        #region[Define]
        DbCommand cmd;
        #endregion
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public async Task<List<TDTO>> ExecuteReaderAsync<TDTO>(string sProcName, CommandType commandType = CommandType.StoredProcedure) where TDTO : new()
        {
        ...
        public async Task<List<TDTO>> ExecuteReaderAsync<TDTO>(string sProcName, List<SqlParameter> externalParameter, CommandType commandType = CommandType.StoredProcedure) where TDTO : new()
        {
            cmd.CommandText = sProcName;
            cmd.CommandType = commandType;
            cmd.Connection = _dbContext.Database.GetDbConnection();
            _dbContext.Database.OpenConnection();
            foreach (var item in externalParameter) 
        ...
        /// <returns></returns>
        public List<TDTO> ExecuteReader<TDTO>(string sProcName, CommandType commandType, out int TotalCounts, out double TotalPages) where TDTO : new()
        {
            cmd.CommandText = sProcName;
            cmd.CommandType = commandType;
            cmd.Connection = _dbContext.Database.GetDbConnection();
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public DataTable ExecuteReader(string sProcName, CommandType commandType)
        {
        ...
        #region[Helper]
        public DbCommand GetDbCommand => cmd;
